...
drop policy if exists "Users can view own tracked cards" on public.user_tracked_cards;
create policy "Users can view own tracked cards" 
on public.user_tracked_cards 
for select 
using (auth.uid() = user_id);

drop policy if exists "Users can insert own tracked cards" on public.user_tracked_cards;
create policy "Users can insert own tracked cards" 
on public.user_tracked_cards 
for insert 
with check (auth.uid() = user_id);

drop policy if exists "Users can delete own tracked cards" on public.user_tracked_cards;
...
drop policy if exists "Users can view own tracked sets" on public.user_tracked_sets;
create policy "Users can view own tracked sets" 
on public.user_tracked_sets 
for select 
using (auth.uid() = user_id);

drop policy if exists "Users can insert own tracked sets" on public.user_tracked_sets;
create policy "Users can insert own tracked sets" 
on public.user_tracked_sets 
for insert 
with check (auth.uid() = user_id);

drop policy if exists "Users can delete own tracked sets" on public.user_tracked_sets;

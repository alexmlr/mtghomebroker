...
interface CardDetailsData {
    ...
    lm_sell_brl: number;
    mtgjson_uuid?: string;
    // New fields optional in interface as they might be missing
    tcgplayer_market_usd?: number;
    cardmarket_avg_eur?: number;
    mtgo_cardhoarder_tix?: number;
}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-12">
                ...
                <div className="card bg-white dark:bg-slate-900 border-none p-4">
                    ...
                    <div className="space-y-3">
                        ...
                        {/* New Scryfall Links (TCGplayer, Cardmarket, Cardhoarder) */}
                        {scryfallData?.purchase_uris?.tcgplayer && (
                            <a
                                ...
                                className="flex items-center justify-between p-3 bg-[var(--inner-bg)] border border-[var(--inner-border)] rounded-xl hover:brightness-110 transition-all group"
                            >
                                <span className="font-medium text-gray-700 dark:text-gray-300">TCGplayer</span>
                                <ExternalLink size={16} className="text-gray-400 dark:text-gray-500 group-hover:text-blue-400" />
                            </a>
                        )}
                        {scryfallData?.purchase_uris?.cardmarket && (
                            <a
                                ...
                                className="flex items-center justify-between p-3 bg-[var(--inner-bg)] border border-[var(--inner-border)] rounded-xl hover:brightness-110 transition-all group"
                            >
                                <span className="font-medium text-gray-700 dark:text-gray-300">Cardmarket</span>
                                <ExternalLink size={16} className="text-gray-400 dark:text-gray-500 group-hover:text-blue-400" />
                            </a>
                        )}
                        {scryfallData?.purchase_uris?.cardhoarder && (
                            <a
                                ...
                                className="flex items-center justify-between p-3 bg-[var(--inner-bg)] border border-[var(--inner-border)] rounded-xl hover:brightness-110 transition-all group"
                            >
                                <span className="font-medium text-gray-700 dark:text-gray-300">Cardhoarder (MTGO)</span>
                                <ExternalLink size={16} className="text-gray-400 dark:text-gray-500 group-hover:text-blue-400" />
                            </a>
                        )}
                        <a
